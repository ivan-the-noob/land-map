            ...
            $mail->Body = "
                <div style='font-family: Roboto, Arial, sans-serif; line-height: 1.6; color: #333; font-size: 16px;'>
                    ...
                    <div style='margin: 20px 0;'>
                        <a href='http://localhost:2000/backend/verify_email.php?code=$verification_code' style='display: inline-block; padding: 12px 20px; font-size: 16px; font-weight: bold; color: #fff; text-decoration: none; background-color: #28a745; border-radius: 5px;'>Verify Email</a>
                    </div>
