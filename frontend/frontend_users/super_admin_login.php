    ...
    <div class="az-signin-wrapper">
        ...
        <div class="az-card-signin">
            ...
            <div class="az-signin-header">
                ...
                <form method="POST" id="signin-form" action="../backend/super_admin_login.php">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#signin-form').on('submit', function (event) {
                ...
                $.ajax({
                    url: "../backend/super_admin_login.php",  // Use the updated login endpoint
                    type: "POST",
                    ...
                    success: function (response) {
                        ...
                        if (result.success) {
                            ...
                            Swal.fire({
                                title: 'Welcome ' + result.username, // Correct username from response
