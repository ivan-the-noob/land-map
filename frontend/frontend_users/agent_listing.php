                                    ...
                                    <div class="filter-item">
                                        ...
                                        <select name="propertyLocation" class="form-control" id="propertyLocation">
                                            ...
                                            <optgroup label="Barangays - Indang">
                                                ...
                                                <option value="Alulod, Indang, Cavite">Alulod, Indang, Cavite</option>
                                                <option value="Banaba, Indang, Cavite">Banaba, Indang, Cavite</option>
                                                <option value="Carasuchi, Indang, Cavite">Carasuchi, Indang, Cavite</option>
                                                <option value="Daine, Indang, Cavite">Daine, Indang, Cavite</option>
                                                <option value="Guyam Malaki, Indang, Cavite">Guyam Malaki, Indang, Cavite</option>
                                                <option value="Guyam Munti, Indang, Cavite">Guyam Munti, Indang, Cavite</option>
                                                <option value="Kaytapos, Indang, Cavite">Kaytapos, Indang, Cavite</option>
                                                <option value="Limbon, Indang, Cavite">Limbon, Indang, Cavite</option>
                                                <option value="Lumampong, Indang, Cavite">Lumampong, Indang, Cavite</option>
                                            </optgroup>

                                            <optgroup label="Barangays - Kawit">
                                                <option value="Binakayan, Kawit, Cavite">Binakayan, Kawit, Cavite</option>
                                                <option value="Gahak, Kawit, Cavite">Gahak, Kawit, Cavite</option>
                                                <option value="Kaingen, Kawit, Cavite">Kaingen, Kawit, Cavite</option>
                                                <option value="Magdalo, Kawit, Cavite">Magdalo, Kawit, Cavite</option>
                                                <option value="Marulas, Kawit, Cavite">Marulas, Kawit, Cavite</option>
                                                <option value="Poblacion, Kawit, Cavite">Poblacion, Kawit, Cavite</option>
                                                <option value="Samala, Kawit, Cavite">Samala, Kawit, Cavite</option>
                                                <option value="Tabon, Kawit, Cavite">Tabon, Kawit, Cavite</option>
                                            </optgroup>
