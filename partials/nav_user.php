...
<div class="container">
    ...
    <div class="az-header-menu">
        ...
        <!--Navigation Bar Head-->
        <ul class="nav">
            <!-- for user to Listing properties -->
            <li class="">
                <a href="../frontend_users/user_listing.php" class="nav-link"><i class="typcn typcn-th-list"></i> My Listing</a>
            </li>
            <!--for user to view properties-->
            <li class="">
                <a href="../frontend_users/user_landproperties.php" class="nav-link"><i class="typcn typcn-location"></i> Land Properties</a>
            </li>
            <!--for user to view agents-->
            <li class="">
                <a href="../frontend_users/user_agents.php" class="nav-link"><i class="fas fa-user"></i> Brokers</a>
            </li>
            <!--for user to view chat-->
            <li class="">
                <a href="../frontend_users/user_inquiries.php" class="nav-link"><i class="typcn typcn-calendar"></i> My Land Inquiries</a>
            </li>
        </ul>
...
<!-- az-header-notification -->
        <div class="dropdown az-profile-menu">
            ...
            <div class="dropdown-menu">
                ...
                <a href="profile.php" class="dropdown-item" styl\e="display: flex; align-items: center; padding: 8px 15px; color: #1b2e4b; transition: all 0.2s ease;">
